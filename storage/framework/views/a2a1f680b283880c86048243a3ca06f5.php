            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Astrology Prediction
                        by Astrologers</div><br>
                       <p> Purchase this script officially from https://www.codester.com/items/44883/astrotalks-astrology-consultation-script and get lifetime free support with working code. +977-9814581248(Whatsapp)
                       </p>
                </div>
            </div>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Adviserxiis\Backened\resources\views/pages/login.blade.php ENDPATH**/ ?>