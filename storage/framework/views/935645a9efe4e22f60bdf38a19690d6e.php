...
<body>
    ...
    <nav id="pageheader"class="navbar navbar-expand-lg  theme-nav fixed-top">
        <div class="container" style="display:initial!important">
            <a class="navbar-brand" href="<?php echo e(url('home')); ?>#home" [pageScrollOffset]="75" pageScroll><img
                    src="/build/assets/images/logoicon1.png" alt="logo"
                    style="height: auto;width: 200px;vertical-align: middle !important;"><span
                    style="font-size:42px;color:#fff;vertical-align: middle !important;"></span></a>
            ...
            <div class="collapse navbar-collapse float-right" id="mainmenu">
                <ul class="navbar-nav" id="mymenu" style="margin: auto !important;">
                    <li class="nav-item ">
                        <a class="headerTitle nav-link" href="<?php echo e(url('home')); ?>#home" onClick="showMenu()"
                            [pageScrollOffset]="75" pageScroll>HOME</a>
                    </li>
                    <li class="nav-item">
                        <a class="headerTitle nav-link" href="<?php echo e(url('home')); ?>#about" onClick="showMenu()"
                            [pageScrollOffset]="75" pageScroll>ABOUT</a>
                    </li>
                    <!-- <li class="nav-item">
                        <a class="headerTitle nav-link" href="<?php echo e(url('home')); ?>#feature" onClick="showMenu()"
                            [pageScrollOffset]="75" pageScroll>FEATURES</a>
                    </li> -->
                    <!-- <li class="nav-item">
                        <a class="headerTitle nav-link" href="<?php echo e(url('home')); ?>#testimonial" onClick="showMenu()"
                            [pageScrollOffset]="75" pageScroll>TESTIMONIAL</a>
                    </li> -->

                    <li class="nav-item">
                        <a class="headerTitle nav-link" href="<?php echo e(url('home')); ?>#contact" onClick="showMenu()"
    ...
    <footer class="cpoy-right-bg">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <p class="copyright">Copyright by Adviserxiis</p>
                </div>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\Users\dell\Adviserxiis\Backened\resources\views/layout/app.blade.php ENDPATH**/ ?>