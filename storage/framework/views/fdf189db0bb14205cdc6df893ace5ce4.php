                ...
                <div class="blog-details news-slid">
                    <div class="news-text">
                        ...
                        <p>
                            ...
                            copyright,
                            database rights and
                            other intellectual property rights related to it, still belong to Adviserxiis.
                        </p>
                        <p>
                        ...
                        <p>
                            AsthaJyotish is committed to ensuring that the app is as useful and efficient as possible. For
                            that
                            reason,
                            we reserve the
                        ...
                        <p>
                            The Adviserxiis app stores and processes personal data that you have provided to us, in order
                            to
                            provide
                            our Service. It’s
                            ...
                            your phone’s
                            security features
                            and it could mean that the Adviserxiis app won’t work properly or at all.
                        </p>
                        <div>
                            <p>
                        ...
                        <p>
                            You should be aware that there are certain things that Adviserxiis will not take
                            responsibility
                            for.
                            ...
                            but Adviserxiis cannot take responsibility for the app not working at full functionality if
                            you
                            don’t
                            have
                            access to
                        ...
                        <p>
                            Along the same lines, Adviserxiis cannot always take responsibility for the way you use the
                            app
                            i.e.
                            You
                            need to make sure
                        ...
                        <p>
                            With respect to Adviserxiis’s responsibility for your use of the app, when you’re using the
                            app,
                            it’s
                            ...
                            to us so that we can make it available to you. Adviserxiis accepts no liability for any loss,
                            direct
                            or
                            indirect, you
                        ...
                        <p>
                            ...
                            the updates if you want to keep using the app. Adviserxiis does not promise that it will
                            always
                            update
                            the
                            app so that it
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Adviserxiis\Backened\resources\views/terms.blade.php ENDPATH**/ ?>