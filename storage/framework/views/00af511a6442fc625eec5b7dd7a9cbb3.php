                                ...
                                <a href="<?php echo e(route('callHistory')); ?>">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <p>purchase this script officially from https://www.codester.com/items/44883/astrotalks-astrology-consultation-script and get lifetime free support with working code. </p>
                                ...
                                <a href="<?php echo e(route('partnerWiseEarning')); ?>">
                                    <div class="report-box">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-3xl font-medium leading-8 mt-6"><?php echo e(round($dash['totalEarning'],2)); ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Adviserxiis\Backened\resources\views/pages/dashboard-overview-1.blade.php ENDPATH**/ ?>