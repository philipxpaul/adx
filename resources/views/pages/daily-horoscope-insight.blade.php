                                ...
                                <div class="sm:grid grid-cols gap-2">
                                    ...
                                    <div class="input">
                                        <div>
                                            ...
                                            <input onkeypress="return validateJavascript(event);" type="text" id="title" name="title" class="form-control"
                                    ...
                                    <div class="input">
                                        <div>
                                            ...
                                            <input onkeypress="return validateJavascript(event);" type="text" id="link" name="link" class="form-control"
                                                placeholder="Link" aria-describedby="input-group-3" required>
                                        </div>
                                    </div>
