...
@section('subhead')
    <title>AsthaJyotish in News</title>
@endsection

@section('subcontent')
    <div class="loader"></div>
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">AsthaJyotish News</h2>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Add AsthaJyotish News</h2>
                </div>
                <form id="add-form"method="POST" enctype="multipart/form-data">
                    ...
                    <div id="input" class="p-5">
                        <div class="preview">
                            ...
                            <div class="mt-5"><button class="btn btn-primary shadow-md mr-2">Add AsthaJyotish News</button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Edit AsthaJyotish News</h2>
                </div>
